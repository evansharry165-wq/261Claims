...
(function (global) {
  ...
  var FILING_CATEGORIES = [
    ...
    { id: 'disco', name: 'DISCO — Disruption Records', icon: 'ti-timeline-event', libKey: 'disco', tier: 'K', group: 'Always required' },
    { id: 'aims', name: 'AIMS — Crew Route & FDP', icon: 'ti-users', libKey: 'aims', tier: 'K', group: 'Always required' },
    { id: 'safetynet', name: 'SafetyNet Reports', icon: 'ti-shield-check', libKey: 'safetynet', tier: 'K', group: 'Always required' },
    ...
    { id: 'amos', name: 'AMOS — Technical Events', icon: 'ti-tool', libKey: 'amos', tier: 'K', group: 'Technical' },
  ...
  function seedFiles() {
    return [
      mk('f001', 'tops', '2026-03-14', 'HC1184_TOPS_FlightDetails_14Mar2026.pdf', { flights: ['HC 1184'], routes: 'LTN-BCN', uploadedBy: 'EH', source: 'API', size: 284000 }),
      mk('f002', 'disco', '2026-03-14', 'HC1184_DISCO_DisruptionRecord_14Mar2026.pdf', { flights: ['HC 1184'], routes: 'LTN-BCN', uploadedBy: 'EH', source: 'API', size: 156000 }),
      mk('f003', 'aims', '2026-03-14', 'HC1184_AIMS_CrewFDP_14Mar2026.pdf', { flights: ['HC 1184'], routes: 'LTN-BCN', uploadedBy: 'EH', source: 'API', size: 98000 }),
      ...
      mk('f008', 'tops', '2026-04-09', 'HC307_TOPS_DelayCode_09Apr2026.pdf', { flights: ['HC 307'], routes: 'MAN-AMS', uploadedBy: 'EH', source: 'API', size: 271000 }),
      mk('f009', 'disco', '2026-04-09', 'HC307_DISCO_ATCDelay_09Apr2026.pdf', { flights: ['HC 307'], routes: 'MAN-AMS', uploadedBy: 'EH', source: 'API', size: 143000 }),
      ...
      mk('f011', 'aims', '2026-04-09', 'HC307_AIMS_CrewRoute_09Apr2026.pdf', { flights: ['HC 307'], routes: 'MAN-AMS', uploadedBy: 'EH', source: 'API', size: 91000 }),
      mk('f012', 'safetynet', '2026-04-09', 'HC307_SafetyNet_09Apr2026.pdf', { flights: ['HC 307'], routes: 'MAN-AMS', uploadedBy: 'EH', source: 'API', size: 76000 }),
      mk('f013', 'tops', '2026-04-28', 'HC330_TOPS_WeatherDelay_28Apr2026.pdf', { flights: ['HC 330'], routes: 'LGW-ALC', uploadedBy: 'EH', source: 'API', size: 295000 }),
      ...
      mk('f016', 'disco', '2026-04-28', 'HC330_DISCO_Weather_28Apr2026.pdf', { flights: ['HC 330'], routes: 'LGW-ALC', uploadedBy: 'EH', source: 'API', size: 152000 }),
      ...
      mk('f019', 'aims', '2026-04-28', 'HC330_AIMS_CrewFDP_28Apr2026.pdf', { flights: ['HC 330'], routes: 'LGW-ALC', uploadedBy: 'EH', source: 'API', size: 94000 }),
      mk('f020', 'safetynet', '2026-04-28', 'HC330_SafetyNet_28Apr2026.pdf', { flights: ['HC 330'], routes: 'LGW-ALC', uploadedBy: 'EH', source: 'API', size: 73000 }),
