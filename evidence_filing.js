...
(function (global) {
  ...
  var FILING_CATEGORIES = [
    ...
    { id: 'max_ops', name: 'Passenger communications log (SMS / email)', icon: 'ti-message', libKey: 'max_ops', tier: 'S', group: 'Passenger care' },
    { id: 'dpm', name: 'Duty manager notes & Ops Review', icon: 'ti-notes', libKey: 'dpm', tier: 'S', group: 'Operational context' },
