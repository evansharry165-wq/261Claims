...
var DefendAbleTrees = (function () {
  ...
  var DEFINITIONS = [
...

    {
      ...
      authority: 'LE v TAP Air Portugal C-74/19 — external, uncontrollable event requiring mandatory commander diversion is EC by analogy; Air Navigation Order / ICAO Annex 6 mandatory diversion duty; distinct from crew illness (Lipton [2024] UKSC 24), which turns on the airline\'s own workforce planning',
      priority: 8,
      ecGateId: 'DT9-G4',
      matches: function (t) {
        var s = t || '';
      ...
      gates: [
        ...
        {
          id: 'DT9-G2', name: 'Foreseeable before boarding', type: 'confirm',
          question: 'Did crew ignore obvious pre-boarding signs, or was the medical event otherwise foreseeable before departure?',
          iccPattern: /\bknown before boarding|\bapparent at check.?in|\bboarded (despite|regardless)|\balready unwell at (the )?gate\b/i,
          onYes: 'DT9-G3', onNo: 'DT9-G4'
        },
        {
          id: 'DT9-G3', name: 'Foreseeable/pre-boarding — concede', type: 'concede',
          authority: 'Narrow exception — crew ignored obvious pre-boarding signs or the event was foreseeable at boarding, within the carrier\'s control at that point.',
          reason: 'Medical event was foreseeable before boarding and the carrier proceeded regardless.',
          conclusion: 'Foreseeable passenger medical condition, boarded despite obvious pre-boarding signs — NOT extraordinary circumstances at that point; concede EC.',
          conditions: ['Concede EC — assess quantum, Art 8 rerouting, and Art 9 care only.']
        },
        {
          id: 'DT9-G4', name: 'Mandatory commander diversion — EC established', type: 'confirm',
          question: 'Was the diversion a mandatory commander response under the Air Navigation Order / ICAO Annex 6 to an external, unforeseeable passenger medical event?',
          authority: 'LE v TAP Air Portugal C-74/19 — external event requiring mandatory commander diversion is EC by analogy',
          iccPattern: /\bmedical\b|\bcardiac\b|\bwelfare\b/i,
          conclusionIds: ['DT9_MEDICAL_EXTERNAL_EC', 'U7_EC_ESTABLISHED'],
          yesMeans: 'Passenger medical emergency requiring mandatory commander diversion — external cause, beyond airline control. EC established.',
          onYes: 'DT9-G5', onNo: 'ROUTE_AWAY'
        },
        stdMeasures('DT9-G5', 'DT9')
      ]
    },
