  ...
  function applyEmbed() {
    ...
    if (!style) {
      ...
      style.textContent =
        ...
        'body.embed-mode .content,body.embed-mode .main{flex:1;overflow-y:auto;min-height:0;-webkit-overflow-scrolling:touch}' +
        'html.embed-mode,body.embed-mode{height:100%!important;overflow:hidden}' +
        'body.embed-mode .filter-bar{flex-shrink:0}' +
        'body.embed-mode .cpr-item:hover{background:var(--surface2)}';
